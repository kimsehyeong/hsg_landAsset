        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-3">협의담당부서 관리</h4>
                            <div style="position: relative;"><button type="button" class="btn btn-success waves-effect waves-light posit-right" data-bs-toggle="modal" data-bs-target=".modal1">등록</button></div>
                                   ...
                                   <colgroup>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>환경과</td>
                                            <td>6건</td>
                                            <td><button type="button" class="btn btn-primary waves-effect waves-light" onclick="location.href='/admin/department/agreement'">관리</button></td>
                                            <td>0명</td>
                                            <td><button type="button" class="btn btn-primary waves-effect waves-light" onclick="location.href='/admin/department/manager'">관리</button></td>
